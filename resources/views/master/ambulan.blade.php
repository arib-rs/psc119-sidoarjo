        ...
        $(function() {
            ...
            $('#btn-save').click(function() {
                ...
                if (id == '') {
                    ...
                    url = "ambulan/" + id;
                    method =
                    'POST'; //kalo pake ini di new FormData, ga mempan, return null di field upload image nya
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.resources.health_facility_id == null) {
                        ...
                        $('.select-form').select2().html(result.health_facilities);
                        form.find('#health_facility_id option[value="' + result.resources
                            .health_facility_id + '"]').attr(
                            'selected',
                            'selected');
                    }
                    $("#pict").trigger('change');
