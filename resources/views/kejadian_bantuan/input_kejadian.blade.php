...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row" style="margin: 0px;">
            ...
            <div id="timer-bg" class="col-md-12" style="background:#66CC00; margin: 0; margin-bottom: 1em; text-align: center; padding: 1rem;">
                <p style="font-size: 4rem; vertical-align: middle; margin: 0; color: #F4F4F4;">Timer: <span id="timer">00:00:00</span></p>
            </div>
            <!-- <div class="col-md-2"></div> -->
        </div>
        <div class="row">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <div style="text-align: right; margin: 0.5% 0.5% 0.5% auto">
                            <button type="submit" class="btn" style="background-color: #3399FF; color:#fff; margin: auto 0.3%;">Simpan
                                Laporan</button>
                            <button type="submit" class="btn" style="background-color: #FF9933; color:#fff; margin: auto 0.3%;">Batalkan
                                Laporan</button>
                        </div>
                    </ul><br>
                            ...
                            <form role="form">
                                <div class="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" value="" name="kode_kasus" id="kode_kasus" readonly>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <select class="form-control select2" id="lanjutan_kasus" name="lanjutan_kasus">
                                                <option> -- Pilih CCN -- </option>
                                                @foreach ($ccn as $d)
                                                <option value='{{ $d->kode_kasus }}'>
                                                    {{ $d->kode_kasus . ' - ' . $d->nama_pelapor }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right" id="waktu" name="waktu">
                                            </div>
                                        </div>
                                        <div class="col-md-1"></div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-4">
                                            <a class="btn btn-danger disabled" style="border-radius: 20px;">Dispatch</a>
                                            <a class="btn hoversolvedbyphone" style="background-color: #fff; color:#b1b1b1; border-radius: 20px; transition-duration: 0.4s;">Solved
                                                By Phone</a>
                                            <a class="btn hoverprankcall" style="background-color: #fff; color:#b1b1b1; border-radius: 20px; transition-duration: 0.4s;">Prank
                                                Call</a>
                                        </div>
                                    </div><br>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" rows="4" id="detail_lokasi" name="detail_lokasi" placeholder="This textarea has a limit of 255 chars"></textarea>
                                        </div>
                                    </div>
                                    {{-- <div class="row">
                                            <div class="col-md-5">
